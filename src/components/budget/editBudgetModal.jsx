...
export default function EditBudgetModal({ isOpen, onClose, onSubmit, budget }) {
  ...
  const addCategory = (predefined = null) => {
    ...
    // Prevent adding a category if one with the same name already exists
  ...
  return (
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="w-full max-w-2xl max-h-[90vh] flex flex-col rounded-3xl glass-card-purple border border-white/20 shadow-2xl">
        {/* Header */}
        <div className="p-6 border-b border-white/10 flex items-center justify-between flex-shrink-0">
          <h2 className="text-2xl font-bold text-white">Editar Presupuesto</h2>
          <Button
            variant="ghost"
            size="icon"
            onClick={onClose}
